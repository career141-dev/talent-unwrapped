...
export const SpeakersProfileSection = (): JSX.Element => {
  ...
  return (
    <section id="speakers" className="relative w-full bg-white py-10 sm:py-12 md:py-16 lg:py-[60px] px-0 sm:px-6 md:px-10 lg:px-[60px] overflow-hidden" style={{overflowX: 'hidden'}}>
