 ...
 * NotFoundPage
 *
 * This is the 404 page. It shows up whenever someone visits a URL
 * that doesn't exist in the app (e.g., /random-page).
 *
 * The animated digits are handled with Framer Motion.
 * The "Back to Home" button takes users back to the home page (`/`).
 */
