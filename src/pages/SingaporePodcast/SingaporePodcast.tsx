        ...
        <div className="w-full max-w-[1280px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-[32px]">
            {episodes.map((episode) => (
              <article
                key={episode.id}
                className="flex flex-col bg-white rounded-[16px] overflow-hidden shadow-[0px_4px_16px_rgba(0,0,0,0.08)] hover:shadow-[0px_8px_24px_rgba(0,0,0,0.12)] transition-shadow duration-300"
              >
                ...
                <div className="flex flex-col p-[24px] flex-1">
                  ...
                  <button
                    ...
                    className="mt-[20px] w-full bg-transparent border-0 text-[#7c3] text-[13px] font-bold tracking-[0.05em] uppercase py-[12px] hover:bg-[#f0f9f0] rounded-[8px] transition-colors duration-200 cursor-pointer"
