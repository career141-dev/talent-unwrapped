...
export const AboutUsSection = (): JSX.Element => {
  ...
  return (
    <section id="about" className="relative w-full max-w-[1440px] min-h-[800px] md:min-h-[1000px] lg:h-[1134px] bg-white px-4 sm:px-6 md:px-10 lg:px-[60px] py-8 md:py-12 lg:py-0 mx-auto overflow-hidden">
      ...
      <div className="flex flex-col w-full lg:w-[203px] items-center lg:items-start gap-2 lg:gap-3 relative lg:absolute top-auto lg:top-[254px] left-0 lg:left-[79px] mb-8 lg:mb-0">
      ...
      <div className="hidden lg:flex absolute top-[228px] left-[871px] w-[152px] h-[106px] rounded-xl overflow-hidden rotate-[-7.30deg] shadow-[12px_12px_30px_#00000017] bg-[linear-gradient(0deg,rgba(0,0,0,0.2)_0%,rgba(0,0,0,0.2)_100%),linear-gradient(0deg,rgba(255,255,255,1)_0%,rgba(255,255,255,1)_100%)]">
        <img
          ...
          src="https://c.animaapp.com/mkmm0u1u5wob0l/img/man-in-headphones-having-interview-2025-10-26-23-44-27-utc-1.png"
        />
      </div>
      ...
      <div className="hidden lg:flex absolute top-72 left-[1125px] w-[152px] h-[106px] rounded-xl overflow-hidden rotate-[6.49deg] shadow-[12px_12px_30px_#00000017] bg-[linear-gradient(0deg,rgba(0,0,0,0.2)_0%,rgba(0,0,0,0.2)_100%),linear-gradient(0deg,rgba(255,255,255,1)_0%,rgba(255,255,255,1)_100%)]">
        <img
          ...
          src="https://c.animaapp.com/mkmm0u1u5wob0l/img/young-black-man-in-headphones-talking-in-microphon-2025-03-13-12.png"
        />
      </div>

      <div className="flex flex-col w-full lg:w-[1223px] items-center lg:items-start gap-2 relative lg:absolute top-auto lg:top-[568px] left-0 lg:left-[60px] text-center lg:text-left">
