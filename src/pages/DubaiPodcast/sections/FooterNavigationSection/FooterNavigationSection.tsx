      ...
      {footerLinks.map((link, index) =>
        link.href ? (
          <a
            key={index}
            href={link.href}
            className="relative w-fit [font-family:'Geist',Helvetica] font-normal text-[#222223] text-base tracking-[-0.32px] leading-[20.9px] whitespace-nowrap hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#222223] focus:rounded"
