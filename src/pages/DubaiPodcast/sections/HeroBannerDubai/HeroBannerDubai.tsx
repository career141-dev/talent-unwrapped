...
export const HeroBannerDubai = (): JSX.Element => {
  ...
  return (
    <section className="relative w-full max-w-[1440px] min-h-[600px] md:min-h-[800px] lg:h-[1137px] bg-white px-4 sm:px-6 md:px-10 lg:px-[60px] py-8 md:py-12 lg:py-0 mx-auto">
      ...
      <h1 className="relative lg:absolute top-0 lg:top-[120px] left-0 lg:left-[496px] w-full lg:w-auto max-w-full lg:max-w-[919px] text-center lg:text-left [font-family:'Geist',Helvetica] font-medium text-[#ed2939] text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-[144px] tracking-[-2px] sm:tracking-[-3px] lg:tracking-[-5.76px] leading-tight lg:leading-[normal] mb-8 lg:mb-0">
        ideas that stay
      </h1>
      ...
      <div className="relative lg:absolute top-auto lg:top-[355px] left-0 lg:left-[50%] lg:transform lg:-translate-x-1/2 w-full max-w-[calc(100%-2rem)] lg:max-w-[1320px] h-[400px] sm:h-[500px] md:h-[600px] lg:h-[700px] bg-[#00000033] rounded-2xl lg:rounded-3xl overflow-hidden mt-8 lg:mt-0 mx-auto">
        ...
        {/* Edition Badge */}
        <div className="inline-flex items-center justify-center gap-1.5 sm:gap-2 md:gap-2.5 px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 md:py-2.5 absolute top-4 sm:top-6 md:top-[39px] left-4 sm:left-6 md:left-[49px] bg-[#ed2939] rounded-[40px] z-20">
          <img
