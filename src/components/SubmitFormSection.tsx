...
export const SubmitFormSection = (): JSX.Element => {
  ...
  return (
    <section id="join-us" className="flex w-full max-w-[1500px] flex-col lg:flex-row items-center lg:items-stretch justify-center gap-8 lg:gap-[98px] px-4 sm:px-6 md:px-10 lg:px-[60px] py-10 sm:py-12 md:py-16 lg:py-[60px] relative bg-white mx-auto">
      {/* Left Side - Insights Box */}
      <div className="relative w-full lg:w-[620px] flex-shrink-0">
        <div className="relative w-full h-auto lg:h-full lg:min-h-[600px] bg-white rounded-3xl p-6 sm:p-8 lg:p-12 flex flex-col justify-between">
          
          {/* Main Heading */}
          <div className="mb-6 lg:mb-8">
            <h2 className="[font-family:'Geist',Helvetica] font-medium text-transparent text-3xl sm:text-4xl md:text-5xl lg:text-[75px] tracking-[-2px] sm:tracking-[-3px] lg:tracking-[-4.69px] leading-tight lg:leading-[67.9px]">
              <span className="text-[#7bb302] tracking-[-3.51px]">Ready to </span>
              <span className="text-[#ed2939] tracking-[-3.51px]">
                unwrap
                <br />
              </span>
              <span className="text-[#7bb302] tracking-[-3.51px]">your</span>
              <span className="text-[#ed2939] tracking-[-3.51px]">
                {" "}
                insights ?
              </span>
          ...
          {/* Description */}
          <div className="mb-6 lg:mb-8">
            <p className="[font-family:'Geist',Helvetica] font-normal text-black text-sm sm:text-base lg:text-[18.7px] tracking-[0] leading-relaxed lg:leading-[28.1px]">
              If you&apos;re shaping ideas, leading teams, or driving
              transformation — we&apos;d love to connect. Share your details with
              us here — our team will reach you personally.
            </p>
          </div>
          ...
          <div className="space-y-4 lg:space-y-6 flex-1 flex flex-col justify-center">
            {features.map((feature, index) => (
              <div key={index} className="flex items-start gap-3 lg:gap-4 opacity-80 hover:opacity-100 transition-opacity duration-300">
                <div className="flex-shrink-0 w-6 h-6 lg:w-[30px] lg:h-7 flex items-center justify-center">
                  <img
                ...
                <div className="flex-1">
                  <p className="[font-family:'Poppins',Helvetica] font-normal text-[#444141] text-xs sm:text-sm lg:text-[14.1px] tracking-[0] leading-relaxed lg:leading-[19.9px]">
      ...
      <div className="flex flex-col items-start justify-center gap-10 relative w-full lg:w-[540px] h-auto lg:h-full lg:min-h-[550px] bg-white rounded-3xl shadow-lg p-6 sm:p-8 lg:p-12 lg:ml-8 mt-8 lg:mt-10">
        <form
